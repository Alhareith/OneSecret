...
FAILED_CANCEL_CODE_LIMIT = RateLimit(maximum=3, window_seconds=15 * 60)
FAILED_CANCEL_CODE_GLOBAL_LIMIT = RateLimit(maximum=5, window_seconds=15 * 60)
MAX_WINDOW_SECONDS = max(
    ...
    FAILED_CANCEL_CODE_GLOBAL_LIMIT.window_seconds,
)
