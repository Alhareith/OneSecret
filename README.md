...
الإصدار **V1.1.1** يحافظ على تحصين V1.1 وسلوك الرسائل الأساسي، ويضيف إطلاقًا موثقًا وبوابة جودة مستقرة وREADME تقنيًا محايدًا. لا يتضمن هذا الإصدار تغييرًا وظيفيًا في التشفير أو API أو تجربة الاستخدام.
...
تفاصيل التحصين وقيوده التشغيلية موجودة في [`docs/13-v1-1-hardening-design.md`](./docs/13-v1-1-hardening-design.md)، بينما يوثق [`docs/15-v1-1-1-release.md`](./docs/15-v1-1-1-release.md) نطاق إصدار الصيانة هذا.
